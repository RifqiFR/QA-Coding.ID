...
Mobile.verifyElementExist(findTestObject('Homepage/menu__btn_Webview'), 0)

Mobile.tap(findTestObject('Homepage/menu__btn_Webview'), 0)

Mobile.waitForElementPresent(findTestObject('Webview/txt_Webview'), 0)

Mobile.verifyElementVisible(findTestObject('Webview/txt_Webview'), 0)
