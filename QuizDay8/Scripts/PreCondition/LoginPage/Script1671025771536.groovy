...
Mobile.verifyElementExist(findTestObject('Homepage/menu__btn_Login'), 0)

Mobile.tap(findTestObject('Homepage/menu__btn_Login'), 0)

Mobile.waitForElementPresent(findTestObject('Login/txt_Login'), 0)
